...
const EstimateRequestEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>
      New estimate request from {name} — {fmt(estimateMin)}–{fmt(estimateMax)}
    </Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={subtitle}>
          A visitor used the cost calculator on allcolourspainter.com and is happy with the
          estimate.
        </Text>
        ...
        <Hr style={hr} />
        <Text style={footer}>
          Reply directly to this email to respond to {name}. Final price is confirmed after a free
          on-site visit.
        </Text>
      </Container>
    </Body>
