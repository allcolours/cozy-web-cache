  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={subtitle}>
          We've received your estimate request and will get back to you within one working day to
          arrange a free on-site visit.
        </Text>

        <Section style={totalBox}>
          <Text style={totalLabel}>Your estimate range</Text>
          <Text style={totalValue}>
            {fmt(estimateMin)} – {fmt(estimateMax)}
          </Text>
        ...
        <Text style={para}>
          1. We'll call or email you within one working day.
          <br />
          2. We arrange a free on-site visit at a time that suits you.
          <br />
        ...
        <Text style={footer}>
          ...
          <a style={link} href={`tel:${SITE.phoneTel}`}>
            {SITE.phoneDisplay}
          </a>{" "}
          or reply to this email.
          <br />— All Colours Painting Contractor Limited, Dublin
        </Text>
      </Container>
    </Body>
  </Html>
