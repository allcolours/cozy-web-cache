  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:image", content: p.cover?.startsWith("http") ? p.cover : `https://allcolourspainter.com${p.cover}` },
        { name: "twitter:image", content: p.cover?.startsWith("http") ? p.cover : `https://allcolourspainter.com${p.cover}` },
