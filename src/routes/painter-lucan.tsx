...
export const Route = createFileRoute("/painter-lucan")({
    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://allcolourspainter.com/painter-lucan",
  ...
  component: () => (
    <LocalAreaPage
      area="Lucan"
      postcode="Co. Dublin"
      intro="Growing residential area with a mix of new builds and established homes — interior and exterior painting for homeowners and developers."
    />
  ),
});
