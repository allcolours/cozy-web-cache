  ...
  head: () => ({
    meta: [
      { title: "About Us | All Colours Painting Contractor Dublin" },
      {
        name: "description",
        content:
          "Meet the team behind All Colours Painting. 10+ years hands-on experience, 300+ projects completed across Dublin, fully insured with 12-month workmanship guarantee.",
      },
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 2,
              name: "About",
              item: "https://allcolourspainter.com/about",
            },
          ],
        }),
      },
...
const pillars = [
  {
    t: "Protection",
    d: "Everything we don't paint is protected. Floors covered, fixtures masked, furniture sheeted — your home or premises is left exactly as we found it.",
  },
  {
    t: "Preparation",
    d: "The finish is only as good as what's underneath. We sand, fill, prime and prep meticulously so paint adheres, lasts and looks right.",
  },
  {
    t: "The Finish",
    d: "Trade-grade paints, sharp cut-ins and clean lines. We leave only when the job genuinely looks finished to a professional standard.",
  },
];
...
const values = [
  {
    t: "Quality first",
    d: "Dulux, Farrow & Ball, Little Greene and Sandtex — properly prepared, properly applied.",
  },
  {
    t: "Tidy on site",
    d: "Daily clean-down, full dust sheeting and respect for your home or workplace.",
  },
  {
    t: "Honest pricing",
    d: "Detailed written quotes with no surprises — what you're quoted is what you pay.",
  },
  { t: "Fully insured", d: "A 12-month workmanship guarantee on every job." },
];
  ...
  return (
    <SiteLayout>
      ...
      <section className="relative isolate overflow-hidden">
        <img
          src={heroAsset.url}
          alt="Period home exterior repainted in sage green by All Colours Painting, Dublin"
          fetchPriority="high"
          decoding="async"
          width={1920}
          height={900}
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 md:grid-cols-2 md:gap-16 md:px-8 md:py-28">
          <div>
            ...
            <div className="mt-8 space-y-5 text-base leading-relaxed text-foreground">
              <p>
                {COMPANY.name} is a painting and decorating company serving {COMPANY.area} for over
                10 years. We've grown almost entirely by word of mouth — most of our work comes from
                clients who've used us before, or from architects and interior designers who trust
                us to finish their projects properly.
              </p>
              <p>
                From a single feature wall in a city flat to full repaints of period townhouses and
                commercial fit-outs, we treat every job the same: prepare meticulously, paint
                cleanly, leave the site spotless.
              </p>
              <p>
                If you're after a contractor who takes pride in straight lines, sharp cut-ins and a
                finish that lasts, you're in the right place.
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-28">
          <div className="max-w-2xl">
            ...
            <h2 className="section-title mt-3 text-3xl md:text-4xl">
              Protection. Preparation. Finish.
            </h2>
            <hr className="section-rule" />
            <p className="mt-6 text-base text-foreground">
              Every job goes through the same three stages, every time. It's how we deliver a clean,
              long-lasting finish.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {pillars.map((p, i) => (
              <div key={p.t} className="border-t-[3px] border-primary bg-card p-8">
                ...
                <h3 className="mt-2 font-display text-xl font-bold uppercase tracking-wide text-[oklch(0.2_0_0)]">
                  {p.t}
                </h3>
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-28">
          <div className="max-w-2xl">
            ...
            <h2 className="section-title mt-3 text-3xl md:text-4xl">
              Ten years, one ladder at a time
            </h2>
            <hr className="section-rule" />
          </div>
            ...
            {[
              {
                y: "2015",
                t: "First brush",
                d: "Started out painting family homes around south Dublin — most of those first clients are still on the books today.",
              },
              {
                y: "2018",
                t: "Going commercial",
                d: "Trusted by our first hotel and office clients, learning to schedule jobs around live businesses without shutting them down.",
              },
              {
                y: "2021",
                t: "Large-scale sites",
                d: "Joined major Dublin construction projects as a specialist painting subcontractor — apartments, student housing, hotels and healthcare.",
              },
              {
                y: "2025",
                t: "A decade on",
                d: "Still answering our own phone, still treating every job the way we'd want our own home painted.",
              },
            ].map((s) => (
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-28">
          <div className="max-w-2xl">
            ...
            <h2 className="section-title mt-3 text-3xl md:text-4xl">
              Large-scale Dublin sites we've worked on
            </h2>
            <hr className="section-rule" />
            <p className="mt-6 text-base text-foreground">
              We've delivered painting and decorating works as a specialist subcontractor on a
              number of major Dublin developments for some of Ireland's leading main contractors and
              developers.
            </p>
          </div>
          <ul className="mt-12 grid gap-4 md:grid-cols-2">
            {[
              ...
              <li
                key={x.p}
                className="flex items-start gap-4 border-l-[3px] border-primary bg-card p-5"
              >
                <div>
          ...
          <p className="mt-8 text-sm text-foreground/70">
            …and many more across residential, hospitality, healthcare and commercial sectors.{" "}
            <Link
              to="/projects"
      ...
      <section className="bg-secondary">
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 md:grid-cols-[1fr_1.2fr] md:gap-16 md:px-8 md:py-28">
          <div className="relative">
            <img
              src={heroAsset.url}
              alt="All Colours Painting team member preparing a residential interior for painting"
              loading="lazy"
              width={900}
              height={1100}
              className="aspect-[4/5] w-full object-cover"
          ...
          <div>
            ...
            <div className="mt-8 space-y-5 text-base leading-relaxed text-foreground md:text-lg">
              <p>
                We're a tight core crew, scaled with trusted painters to 15–30 on site. The person
                who quotes the job is on site for the job. The phone is answered by someone who's
                actually been up a ladder this week. That's not marketing — it's just how a small
                trade business works when it cares about its reputation.
              </p>
              <p>
                Every client we've ever had has come through word of mouth or repeat business. We've
                never paid for a single advert. The day that changes is the day we've stopped doing
                the job properly.
              </p>
              <p>
                If you're trusting us with your home or your premises, you should know who's coming
                through the door. That's why every quote we send includes the name of the lead
                painter who'll be on your job — and you'll meet them at the site visit, not on day
                one.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {values.map((v) => (
              <div key={v.t} className="bg-card p-6">
                ...
                <h3 className="mt-4 font-display text-base font-bold uppercase tracking-wide text-[oklch(0.2_0_0)]">
                  {v.t}
                </h3>
