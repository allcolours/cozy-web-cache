...
const DESC = `Interior repaints and exterior masonry across Ballinteer. Free quotes, fully insured — call ${SITE.phoneDisplay}.`;
    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://allcolourspainter.com/painter-ballinteer",
          telephone: SITE.phoneIntl,
          email: SITE.email,
          areaServed: { "@type": "Place", name: "Ballinteer, Dublin 16" },
          address: {
            "@type": "PostalAddress",
            addressLocality: "Ballinteer",
