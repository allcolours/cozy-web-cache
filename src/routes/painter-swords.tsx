...
export const Route = createFileRoute("/painter-swords")({
  ...
  component: () => <LocalAreaPage area="Swords" postcode="Co. Dublin" intro="Dublin's largest town — residential estates and commercial premises painted efficiently by a reliable, fully insured team." />,
});
