...
export const Route = createFileRoute("/painter-terenure")({
  ...
  component: () => <LocalAreaPage area="Terenure" postcode="Dublin 6W" intro="Traditional family homes and period houses throughout Terenure — interior and exterior repaints with proper prep and trade-grade materials." />,
});
