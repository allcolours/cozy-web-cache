...
const PROJECTS = [
  {
    ...
    location: "Dublin",
    blurb:
      "Specialist painting & decorating works delivered across a multi-unit residential development for one of Ireland's leading main contractors.",
  },
  {
    name: "Hawkins Wood",
    ...
    location: "Dublin",
    blurb:
      "Full interior and exterior painting on a large new-build residential scheme — handed over to Cairn's developer finish standard.",
  },
  {
    ...
    blurb:
      "Bedrooms, corridors, public areas and back-of-house finished to brand specification on a live city-centre hotel build.",
  },
  {
    ...
    blurb:
      "Repeat-block apartment painting at scale — programmed around fit-out trades to keep handovers on schedule.",
  },
  {
    ...
    location: "Dublin",
    blurb:
      "Painting and decorating package delivered alongside fit-out trades on a complex mixed-use site.",
  },
  {
    ...
    blurb:
      "High-traffic spec painting across studios, shared kitchens and amenity areas — durable, hard-wearing finishes throughout.",
  },
  {
    ...
    blurb:
      "Sensitive, low-VOC finishes for family accommodation attached to a working hospital campus.",
  },
  {
    ...
    blurb:
      "Painting works as part of Cairn's flagship Seven Mills neighbourhood — apartments delivered to developer handover standard.",
  },
];
  ...
  head: () => ({
    meta: [
      { title: "Major Projects | All Colours Painting Contractor Limited" },
      {
        name: "description",
        content:
          "Notable Dublin construction projects we've delivered painting & decorating works on as a specialist subcontractor — including Premier Inn North Wall, Cairn Homes, Elliott Group and more.",
      },
      { property: "og:title", content: "Major Dublin Projects — All Colours Painting" },
      {
        property: "og:description",
        content:
          "Specialist painting subcontractor on hotel, residential, student and healthcare projects across Dublin.",
      },
      ...
      { name: "twitter:title", content: "Major Dublin Projects — All Colours Painting" },
      {
        ...
        content: "Hotel, residential, student & healthcare painting projects across Dublin.",
      },
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 2,
              name: "Major Projects",
              item: "https://allcolourspainter.com/projects",
            },
          ],
        }),
      },
  ...
  return (
    <SiteLayout>
      ...
      <section className="relative isolate overflow-hidden">
        <img
          src={heroAsset.url}
          alt="Completed interior and exterior painting projects across Dublin"
          loading="lazy"
          width={1920}
          height={900}
        ...
        <div className="mx-auto max-w-7xl px-4 py-24 md:px-8 md:py-36">
          ...
          <p className="mt-6 max-w-2xl text-base text-white/85 md:text-lg">
            A selection of major construction projects where we've delivered the painting &
            decorating package as a specialist subcontractor — alongside some of Ireland's leading
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-4xl px-4 py-16 md:px-8 md:py-20">
          ...
          <h2 className="section-title mt-3 text-3xl md:text-4xl">
            Trade-grade, on programme, snagged properly
          </h2>
          <hr className="section-rule" />
          <p className="mt-6 text-base leading-relaxed text-foreground md:text-lg">
            On major Dublin developments we work as a painting subcontractor under main contractors
            including Walls Construction, Collen Construction, Cairn Homes, Elliott Group, Bennett
            Construction and Clancy Construction. The same team that paints a private home in
            Ranelagh paints a 200-unit apartment block in Adamstown — the standard doesn't change,
            only the scale.
          </p>
        </div>
      </section>
          ...
          <ul className="mt-12 grid gap-6 md:grid-cols-2">
            {PROJECTS.map((p) => (
              <li key={p.name} className="border-t-[3px] border-primary bg-card p-7">
                ...
                <h3 className="mt-2 font-display text-xl font-bold uppercase leading-tight tracking-wide text-[oklch(0.2_0_0)]">
                  {p.name}
                </h3>
                <div className="mt-1 text-sm text-foreground/70">
                  {p.location} · with {p.contractor}
                </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 px-4 py-16 md:flex-row md:items-center md:px-8 md:py-20">
          <div>
            ...
            <h2 className="mt-2 font-display text-3xl font-extrabold uppercase tracking-tight md:text-4xl">
              Need a painting subcontractor for your next Dublin project?
            </h2>
            <p className="mt-3 max-w-2xl text-white/75">
              {COMPANY.shortName} works across {COMPANY.area} — talk to us about programme, scope
              and rates.
            </p>
          </div>
          <Link
