...
export function WhatsAppButton() {
  ...
  return (
    <a
      href="https://wa.me/353858211870?text=Hi%2C%20I%27d%20like%20a%20free%20quote%20for%20painting%20work%20in%20Dublin."
      target="_blank"
    ...
    >
      ...
      <span className="pointer-events-none absolute right-full top-1/2 mr-3 -translate-y-1/2 whitespace-nowrap rounded bg-[oklch(0.2_0_0)] px-3 py-1.5 text-xs font-medium text-white opacity-0 shadow-lg transition-opacity duration-200 group-hover:opacity-100">
        Chat on WhatsApp
      </span>
    </a>
  );
