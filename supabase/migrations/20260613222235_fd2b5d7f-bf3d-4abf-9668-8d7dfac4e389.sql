...
-- that should only be reachable from trusted server code (service_role).
...
-- has_role is used inside RLS policies for authenticated users; keep it
-- callable by authenticated/service_role only, revoke from anon/public.
